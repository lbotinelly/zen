...
namespace Zen.Base.Common
{
    ...
    public static class MimeTypeMap
    {
        ...
        public static string GetExtension(this string mimeType) { return GetExtension(mimeType, true); }

        public static string GetExtension(this string mimeType, bool throwErrorIfNotFound)
        {
            if (mimeType == null) return throwErrorIfNotFound ? throw new ArgumentNullException(nameof(mimeType)) : (string) null;

            if (mimeType.StartsWith(".")) return throwErrorIfNotFound ? throw new ArgumentException("Requested mime type is not valid: " + mimeType) : (string) null;

            if (_mappings.Value.TryGetValue(mimeType, out var extension)) return extension;
