...
using Zen.Module.Web.Auth.Base.Model.Account;
...
namespace Zen.Module.Web.Auth.Base.Controller
{
    ...
    public class AccountController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public async Task<IActionResult> RegisterFake()
        {
            ...
            var newUser = new Faker<ZenUser>()
                    .RuleFor(u => u.UserName, (f, u) => f.Internet.UserName())
                    .RuleFor(u => u.Email, (f, u) => f.Internet.Email(f.Internet.UserName()))
                ;
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ZenUser { UserName = model.Username, Email = model.Email };
