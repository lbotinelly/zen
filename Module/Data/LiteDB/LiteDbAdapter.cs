...
namespace Zen.Module.Data.LiteDB
{
    public class LiteDbAdapter : DataAdapterPrimitive
    {
        ...
        public override T Get<T>(string key) => ((LiteCollection<T>)_dbCol).FindById(key);
        ...
        public override IEnumerable<T> Get<T>(IEnumerable<string> keys)
        {
            ...
            {
                cache.Add(((LiteCollection<T>)_dbCol).FindById(key));
            }
        ...
        public override IEnumerable<T> All<T>(string statement = null)
        {
            return ((LiteCollection<T>)_dbCol).FindAll();
        }

        public override IEnumerable<TU> All<T, TU>(string statement = null)
        {
            return ((LiteCollection<T>)_dbCol).FindAll().Select(i => i.ToType<TU, T>());
        }

        public override IEnumerable<T> All<T>(QueryPayload payload, string statement = null)
        {
            throw new NotImplementedException();
        }

        public override IEnumerable<TU> All<T, TU>(QueryPayload payload, string statement = null)
        {
            throw new NotImplementedException();
        }
        ...
        public override long Count<T>(string statement)
        {
            throw new NotImplementedException();
        }

        public override long Count<T>(QueryPayload payload)
        {
            throw new NotImplementedException();
        }

        public override long Count<T>(QueryPayload payload, string statement)
        {
            throw new NotImplementedException();
        }

        public override void Insert<T>(Data<T> data)
        {
            throw new NotImplementedException();
        }

        public override void Save<T>(Data<T> model)
        {
            throw new NotImplementedException();
        }
        ...
        public override void Remove<T>(Data<T> model)
        {
            throw new NotImplementedException();
        }
