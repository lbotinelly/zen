...
using Zen.Web.App.Data;
using Zen.Web.Data.Controller;

namespace Zen.Web.App.Communication
{
    public class AppScopedApiController<T> : AppDataController<T> where T : AppScopedContent<T>
    {
        ...
        public override IEnumerable<T> FetchCollection()
        {
            ...
            if (Zen.App.Current.Orchestrator.Application != null) mutator.Transform.AddFilter(new { ApplicationCode = Zen.App.Current.Orchestrator.Application?.Code });

            if (Zen.App.Current.Orchestrator.Person == null || !Zen.App.Current.Orchestrator.HasAnyPermissions(AdminPermission))
            {
        ...
        public override T FetchModel(string key, ref Mutator mutator)
        {
            ...
            var currentApplicationCode = Zen.App.Current.Orchestrator.Application?.Code;
