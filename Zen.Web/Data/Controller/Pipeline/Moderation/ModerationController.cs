...
using Zen.Web.Data.Pipeline.Moderation;

// ReSharper disable InconsistentlySynchronizedField
// ReSharper disable StaticMemberInGenericType
// ReSharper disable InconsistentNaming
namespace Zen.Web.Data.Controller.Pipeline.Moderation
{
    public class ModerationController<T> : ControllerBase where T : Data<T>
    {
        ...
        {
            if (App.Current.Orchestrator?.Person == null) return 0;
            ...
            {
                var q = new {AuthorLocator = App.Current.Orchestrator?.Person.Locator}.ToJson();
        ...
        private IEnumerable<ModerationTask<T>> InternalGetAllTasks()
        {
            ...
            if (App.Current.Orchestrator?.Person == null) return preRet;
