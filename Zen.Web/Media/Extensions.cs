...
namespace Zen.Web.Media
{
    public static class Extensions
    {
        ...
        public static RasterImagePipeline ToRasterImagePipeline(this IQueryCollection source, Stream stream = null, Crop.EPosition position = Crop.EPosition.NotSpecified)
        {
            ...
            if (position == Crop.EPosition.NotSpecified)
            {
                ...
                if (p != null)
                    switch (p.ToLower())
                    {
                        ...
                        case "bottom": position = Crop.EPosition.BottomCenter; break;
                        case "left": position = Crop.EPosition.Left; break;
                        case "right": position = Crop.EPosition.Right; break;
                        default: position = Crop.EPosition.Center; break;
                    }
            }
        ...
        public static RasterImagePipeline ToRasterImagePipeline(this HttpRequest source, Stream stream = null, Crop.EPosition position = Crop.EPosition.Center) { return ToRasterImagePipeline(source.Query, stream, position); }
    }
}