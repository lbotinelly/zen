...
namespace Zen.Pebble.FlexibleData.Geolocation
{
    /// <summary>
    ...
    public class GeoCoordinate : IEquatable<GeoCoordinate>
    {
        ...
        public double Latitude
        {
            ...
            set
            {
                if (value > 90.0 || value < -90.0) throw new ArgumentOutOfRangeException("Latitude", "Argument must be in range of -90 to 90");
                _latitude = value;
            }
        }
        ...
        public double Longitude
        {
            ...
            set
            {
                if (value > 180.0 || value < -180.0) throw new ArgumentOutOfRangeException("Longitude", "Argument must be in range of -180 to 180");
                _longitude = value;
            }
        }
        ...
        public double HorizontalAccuracy
        {
            ...
            set
            {
                if (value < 0.0) throw new ArgumentOutOfRangeException("HorizontalAccuracy", "Argument must be non negative");
        ...
        public double VerticalAccuracy
        {
            ...
            set
            {
                if (value < 0.0) throw new ArgumentOutOfRangeException("VerticalAccuracy", "Argument must be non negative");
        ...
        public double Speed
        {
            ...
            set
            {
                if (value < 0.0) throw new ArgumentOutOfRangeException("speed", "Argument must be non negative");
                _speed = value;
            }
        }
        ...
        public double Course
        {
            ...
            set
            {
                if (value < 0.0 || value > 360.0) throw new ArgumentOutOfRangeException("course", "Argument must be in range 0 to 360");
                _course = value;
            }
        }
        ...
        public bool Equals(GeoCoordinate other)
        {
            ...
            if (!num.Equals(other.Latitude)) return false;
        ...
        /// <param name="left">The first GeoCoordinate to compare.</param>
        /// <param name="right">The second GeoCoordinate to compare.</param>
        public static bool operator !=(GeoCoordinate left, GeoCoordinate right) { return !(left == right); }
        ...
        public double GetDistanceTo(GeoCoordinate other)
        {
            if (double.IsNaN(Latitude) || double.IsNaN(Longitude) || double.IsNaN(other.Latitude) ||
                double.IsNaN(other.Longitude)) throw new ArgumentException("Argument latitude or longitude is not a number");
        ...
        /// </returns>
        public override int GetHashCode() { return Latitude.GetHashCode() ^ Longitude.GetHashCode(); }
        ...
        public override bool Equals(object obj) { return Equals(obj as GeoCoordinate); }
